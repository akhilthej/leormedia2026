...
const description =
  "Read the official Disclaimer of Leor Media. Understand our policies, responsibilities, and terms regarding services and products offered.";
const keywords =
  "disclaimer, Leor Media, terms and conditions, service policies, Visakhapatnam digital agency, product and service guidelines";
  ...
  return (
    <>
      ...
      <div className="disclaimer px-5 mt-6 text-black mx-4">
        ...
        reliability, availability or completeness by us. For example, the
        outlined Disclaimer has been created using PolicyMaker.io, a free web
        application for generating high-quality legal documents. PolicyMaker’s
        disclaimer generator is an easy-to-use tool for creating an excellent
        sample Disclaimer template for a website, blog, eCommerce store or app.
        ...
        is not a substitute for professional financial advice. Accordingly,
        before taking any actions based upon such information, we encourage you
        to consult with the appropriate professionals. We do not provide any
        kind of financial advice. Content published on
        https://leormedia.com is intended to be used and must be used for
        informational purposes only. It is very important to do your own
        analysis before making any decision based on your own personal
        circumstances. You should take independent financial advice from a
        ...
        leormedia Pvt Ltd is not responsible for any errors or omissions
        ...
        leormedia Pvt Ltd, its related partnerships or corporations, or
        ...
        support@leormedia.com. This Disclaimer was created for
        https://leormedia.com by PolicyMaker.io on 2022-11-01.
      </div>
    </>
  );
};
