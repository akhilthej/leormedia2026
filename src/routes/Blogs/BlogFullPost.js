        ...
        <div className="mb-4 md:mb-0 w-full max-w-screen-md mx-auto relative" style={{ height: "24em" }}>
          ...
          <div className="p-4 absolute bottom-0 left-0 z-20">
            <div className="flex mt-3">
              <img src="https://leormedia.com/logo192.png" className="h-10 w-10 rounded-full mr-2 object-cover" />
              <div>
                <p className="font-semibold text-gray-200 text-sm">Leor Media</p>
