...
import { EventsPageData } from "../../../assets/data/PageData";
...
const WebDevelopmentCompanyPage = () => {
  return (
    <div className="max-w-6xl mx-auto mt-28">
      ...
      <main className="space-y-8 my-6">
        ...
        <section 
          ...
          style={{
            backgroundImage: `url("${EventsPageData.coverimage}")`,
            backgroundSize: EventsPageData.coverImage.style.backgroundSize,
            backgroundPosition: EventsPageData.coverImage.style.backgroundPosition,
          }}
        >
        ...
        <section className="px-4">
          <div className="text-center mb-8">
            <p className="text-sm text-gray-600 mb-2">
              {EventsPageData.section2.tagline}
            </p>
            <h2 className="text-2xl md:text-4xl font-bold bg-gradient-to-r from-yellow-400 to-orange-600 bg-clip-text text-transparent mb-3">
              {EventsPageData.section2.heading}
            </h2>
            <p className="text-sm text-gray-700 mb-6">
              {EventsPageData.section2.description}
            </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
            {EventsPageData.services.map((service, index) => (
              <div 
                key={index}
...
export default WebDevelopmentCompanyPage;