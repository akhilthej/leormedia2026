    ...
    <div className="max-w-6xl mx-auto">
      ...
      <main className="space-y-8 my-6">
        ...
        <section
          ...
          style={{
            backgroundImage: `url("${BrandingCompany.coverimage}")`,
            backgroundSize: BrandingCompany.coverImage.style.backgroundSize,
            backgroundPosition:
              BrandingCompany.coverImage.style.backgroundPosition,
          }}
        >
          <div className="text-center text-white max-w-2xl mx-auto">
            <h1 className="text-2xl md:text-4xl font-bold mb-4">
              {BrandingCompany.title}
            </h1>
            <p className="text-sm opacity-90 mb-6">
              {BrandingCompany.subtitle}
            </p>
        ...
        <section className="px-4">
          <div className="text-center mb-8">
            <p className="text-sm text-gray-600 mb-2">
              {BrandingCompany.section2.tagline}
            </p>
            <h2 className="text-2xl md:text-4xl font-bold bg-gradient-to-r from-yellow-400 to-orange-600 bg-clip-text text-transparent mb-3">
              {BrandingCompany.section2.heading}
            </h2>
            <p className="text-sm text-gray-700 mb-6">
              {BrandingCompany.section2.description}
            </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
            {BrandingCompany.services.map((service, index) => (
              <div
                key={index}
